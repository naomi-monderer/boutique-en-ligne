...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : jeu. 07 avr. 2022 à 09:38
...
INSERT INTO `commandes` (`id`, `date`, `id_status`, `total`, `id_utilisateur`, `id_commande`) VALUES
(1, '2022-04-07', 1, '17', 21, 420221550964384),
(2, '2022-04-07', 1, '29', 21, 4202285323277);
...
CREATE TABLE IF NOT EXISTS `detail_commande` (
  ...
  `id_commande` bigint(11) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;
...
INSERT INTO `detail_commande` (`id`, `id_produit`, `quantite`, `id_commande`) VALUES
(1, 3, 1, 420221550964384),
(2, 3, 2, 4202285323277);
...
(2, 'TEST', 'Lorem ipsum dolor sit amet. Et perferendis beatae sed earum quia et voluptas minus et esse dolore ut voluptatem Quis et assumenda asperiores quo sint eligendi. Et sunt perspiciatis est error voluptatem in molestiae adipisci ex amet delectus. Eos laudantium praesentium est rerum cupiditate et aliquid culpa et corrupti doloremque aut quasi maxime eum temporibus placeat qui distinctio incidunt.\r\n\r\n33 ratione sapiente qui omnis delectus in suscipit reiciendis id corporis neque quo nihil culpa id consequatur voluptatem. Sit ullam officiis eum sapiente minima qui quis culpa nam error molestiae qui corrupti pariatur.\r\n\r\nNon porro iure qui praesentium atque et inventore dolores est possimus voluptatum est ipsum nihil ut explicabo esse. Eos suscipit porro ut suscipit tenetur et nemo quasi ex eius culpa? Qui ipsa velit et officia blanditiis aut facilis necessitatibus et expedita quia?', 0, '12', 1, NULL, 'TEST', 1, 1, 1, 'asterix.jpg'),
(3, 'Aterix 2', 'Lorem ipsum dolor sit amet. Et perferendis beatae sed earum quia et voluptas minus et esse dolore ut voluptatem Quis et assumenda asperiores quo sint eligendi. Et sunt perspiciatis est error voluptatem in molestiae adipisci ex amet delectus. Eos laudantium praesentium est rerum cupiditate et aliquid culpa et corrupti doloremque aut quasi maxime eum temporibus placeat qui distinctio incidunt.\r\n\r\n33 ratione sapiente qui omnis delectus in suscipit reiciendis id corporis neque quo nihil culpa id consequatur voluptatem. Sit ullam officiis eum sapiente minima qui quis culpa nam error molestiae qui corrupti pariatur.\r\n\r\nNon porro iure qui praesentium atque et inventore dolores est possimus voluptatum est ipsum nihil ut explicabo esse. Eos suscipit porro ut suscipit tenetur et nemo quasi ex eius culpa? Qui ipsa velit et officia blanditiis aut facilis necessitatibus et expedita quia?', 1, '12', 1, NULL, 'Editeur', 1, 1, 1, 'asterix.jpg');
...
INSERT INTO `souscategories` (`id`, `nom_souscategorie`, `id_categorie`) VALUES
(1, 'Aventure', 1);
